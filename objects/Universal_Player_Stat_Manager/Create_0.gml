...
//       Code   Name          HP    P% DMG ACC H H% S Leech BuffA BuffD
 "TSE": ["TSE", "DEMO Enemy", 999, [00,010,70, 0,00,2,true ,[0,0],[1,5]], 
							       [45,020,60, 0,00,0,false,[0,0],[0,0]], 
							       [80,030,50, 0,00,1,false,[2,5],[0,0]],  
						//	DEF  SP  Is Zedegri(0=Normal, 1=Zedegri, 2=Undazeable
							00,  51, 0],
 "TSZ": ["TSZ", "Test Zedegri",999,[00,056,70, 0,00,2,false,[1,5],[0,0]], 
							       [55,130,65, 0,00,0,false,[0,0],[0,0]], 
							       [82,000,99, 1,20,2,false,[0,0],[2,5]],  
							50,  30, 1],
	//Lahmur Field
 "LCB": ["LCB", "Common Boar", 656,[00,055,110,0,00,2,false,[0,0],[0,0]],
						           [50,085,65, 0,00,2,false,[0,0],[0,0]],
							       [80,000,99, 1,05,2,false,[1,2],[1,2]],
							5,  40, 0],
 "LTW": ["LTW", "Toppleweed", 398, [00,020,80, 0,00,2,true, [0,0],[0,0]],
							       [35,060,75, 0,00,9,false,[1,1],[0,0]],
							       [75,000,99, 1,05,2,false,[0,0],[2,1]],
							05, 38, 0],
 "LSL": ["LSL", "Suckerlip",   552,[00,090,080,0,00,2,true ,[0,0],[0,0]],
							       [50,000,099,1,20,2,false,[0,0],[0,0]],
							       [80,000,099,0,00,2,false,[1,1],[2,1]],
							00, 41, 0],
	//Mountain
 "LMB": ["LMB","Mountain Boar",820,[00,40,110,0,00,2,false, [0,0],[0,0]],
						           [55,065,65, 0,00,0,false,[0,0],[0,0]],
							       [80,000,99, 1,05,2,false,[1,2],[2,2]],
							10,  40, 0],
 "LSW": ["LSW", "Shiny Toppleweed", 748,
                                   [00,067,85, 0,00,2,false,[0,0],[0,0]],
							       [30,085,80, 0,00,0,false,[1,3],[0,0]],
							       [95,000,99, 1,05,3,false,[0,0],[2,1]],
							30, 38, 0],
 "LDL": ["LDL", "Damp Suckerlip", 792,
                                   [00,95,080,1,05,2,true ,[0,2],[0,2]],
							       [50,000,099,1,15,2,false,[0,0],[0,0]],
							       [80,000,099,0,00,2,false,[1,1],[2,1]],
							00, 39, 0],
							
 "LZZ": ["LZZ", "Enemy Zedegri", 1480,
					               [00,470,125,0,00,2,false,[0,0],[0,0]],
							       [60,440,080,0,00,6,false,[1,3],[0,0]],
							       [80,000,000,0,10,2,false,[0,0],[2,3]],
							80, 51, 1],
//Forest Enemies
 "FLB": ["FLB", "Lifebloomer", 720,
						           [00,000,000,2,10,2,false,[0,0],[0,0]],
							       [35,000,000,1,25,2,false,[0,0],[1,5]],
							       [70,080,088,0,00,2,true ,[0,0],[0,0]],
							15, 53, 0],
 "FTT": ["FTT", "Tanky Trotter", 1020,
					               [00,000,000,0,00,2,false,[0,0],[2,2]],
						   	       [20,097,060,0,00,2,false,[0,0],[0,0]],
							       [60,000,000,1,10,2,false,[1,3],[1,3]],
							40, 70, 1],
 "FSF": ["FSF", "Shadowfiend", 1800, //Zedegri Class Enemy
					               [00,500,120,0,00,2,false,[0,0],[0,0]],
							       [40,300,100,0,00,8,false,[0,0],[0,0]],
							       [75,600,080,0,00,2,true ,[0,0],[1,3]],
							60, 45, 1],
//Desert Mina Human
 "DRM": ["DRM", "Rollmaric", 400,  [00,030,075,0,00,5,false,[0,0],[0,0]],
							       [75,020,070,0,00,3,false,[0,0],[0,0]],
							       [90,060,060,0,00,0,false,[0,0],[0,0]],
							20, 56, 0],					
							
 "DHE": ["DHE","Desert Raider",980,[00,050,110,0,00,2,false,[0,0],[0,0]],
							       [60,120,060,0,00,2,false,[0,0],[0,0]],
							       [80,000,000,1,05,2,false,[1,1],[1,1]],
							00, 00, 0],
							
 "DSS": ["DSS", "Sandy Scripo",000,[00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							00, 00, 0],
//Desert Mina Zedegri	HP	 P%,DMG,ACC,H,H%,S,Leech,ATKB, DEFB
 "DOW": ["DOW", "Ophion Worm",2100,[00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							00, 00, 0],
						// DEF,SPD,IsZedegri
 "DSH": ["DSH", "Stellar Hawk", 0000,
                                   [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							00, 00, 0],
// Miscellaneous
 "XXX": ["XXX", "No Enemy",      0, 00, 00, 000, 00,  infinity, 00, 00, 00, 2],
 "BLANK": ["XXX", "BLANK", 0000,   [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							       [00,000,000,0,00,2,false,[0,0],[0,0]],
							00, 00, 0],
							
 "ETHEL": ["ETHEL", "THE HANDS OF GOD", 999999,
					               [00,4000,90,0,00,1,true, [2,9],[1,9]],
