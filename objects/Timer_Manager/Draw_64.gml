...
draw_healthbar(xx,yy+86*2,xx+10000, yy+(86*2)+32, cs/ts,0, speed_colour(cs, ts, "blue"), c_white,0,1,0);
...
draw_healthbar(xx,yy+80*2-32,xx+10000, yy+(80*2)-64, cs/ts,c_black, speed_colour(cs, ts, ""), c_white,0,1,0);
